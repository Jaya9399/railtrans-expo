...
const ENV_ADMIN_EMAIL =
  ...
  (typeof import.meta !== "undefined" && import.meta.env && import.meta.env.VITE_ADMIN_EMAIL) || "***REMOVED***";

const ENV_ADMIN_PASSWORD =
  (process.env.REACT_APP_ADMIN_PASSWORD) ||
  (typeof import.meta !== "undefined" && import.meta.env && import.meta.env.VITE_ADMIN_PASSWORD) || "***REMOVED***";
